	...
	<div class="cat_add_form">
	    <div class="form-horizontal">
            ...
            <div class="form-group form-group-sm">
                ...
                <div class="col-md-2">
                    <label style="margin-top: 11px;">${Detail.id}</label>
                </div>
                <label class="control-label col-md-2">商品名：</label>
                <div class="col-md-2">
                    <label style="margin-top: 11px;">${Detail.name}</label>
                </div>
            </div>
            <div class="form-group form-group-sm">
            <label class="control-label col-md-2">商品价格：</label>
                <div class="col-md-2">
                    <label style="margin-top: 11px;">$${Detail.price}</label>
                </div>
                <label class="control-label col-md-2">商品种类：</label>
                <div class="col-md-2">
                    <label style="margin-top: 11px;">${Detail.category}</label>
                </div>
                <label class="control-label col-md-2">商品库存：</label>
                <div class="col-md-2">
                    <label style="margin-top: 11px;">${Detail.num} </label>
                </div>
            </div>
            <div class="form-group form-group-sm">
                <label class="control-label col-md-2">文章图片：</label>
                <div class="col-md-2">
                    <label style="margin-top: 11px;"><img src="${pageContext.request.contextPath}/assets/images/book-covers/${Detail.imgurl}" width="140" height="212"></label>
                </div>
                <label class="control-label col-md-2">描述：</label>
                <div class="col-md-2">
                    <label style="margin-top: 11px;">${Detail.description}</label>
                </div>
            </div>
            <div class="form-group form-group-sm" style="margin-top: 30px;">
                <div class="col-md-3 col-md-offset-3">
                    <div class="btn-group">
                    <a class="add-to-cart" title="Add to Cart" href="${pageContext.request.contextPath}/AddCarServlet?id=${Detail.id}">Add to Cart</a>
