...
function updateNews_admin(username,table)
{
    ...
    //alert(newstype);
    var url="UodateOneNews_admin?table="+table+"&newsid="+newsid+"&head="+head+"&publish_time="+publish_time+"&author="+author+"&newstype="+newstype;
